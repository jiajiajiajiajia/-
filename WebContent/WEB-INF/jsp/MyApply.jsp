...
<%@ include file="header.jsp"  %>
		...
		<div class="bigbox" style='background:url(images/loginBg.jpg) no-repeat;'> 
			<div class="huishouye"><a href="${pageContext.request.contextPath }/findindex.do">< 返回首页</a></div>
			<div class="senbox" >
			<form name="ApplyList" action="${pageContext.request.contextPath }/findMyApply.do"method="post">
				<br>
                <table border="1" class="tableis" >
					...
					<c:forEach items="${list }" var="list">
						<tr align="center">
							<td>${ list.documen.chiTitle}</td>
							<td>${list.documen.author}</td>
							<td>${list.applytime}</td>
							<td><a href="${pageContext.request.contextPath }/toApply.do?documenid=${list.documen.documenid }">查看详情</a></td>
						</tr>
					</c:forEach>
				</table>	
				<br />
